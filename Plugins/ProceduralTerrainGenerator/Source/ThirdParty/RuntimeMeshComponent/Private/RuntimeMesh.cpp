...
UPtgRuntimeMesh::UPtgRuntimeMesh(const FObjectInitializer& ObjectInitializer)
...
void UPtgRuntimeMesh::Initialize(URuntimeMeshProvider* Provider)
{
...
FRuntimeMeshCollisionHitInfo UPtgRuntimeMesh::GetHitSource(int32 FaceIndex) const
{
...
FBoxSphereBounds UPtgRuntimeMesh::GetLocalBounds() const
{
	FReadScopeLock Lock(MeshProviderLock);
	if (MeshProviderPtr)
	{
...
// 
// void UPtgRuntimeMesh::ShutdownInternal()
// {
// 	Reset();
// }

void UPtgRuntimeMesh::ConfigureLODs(const TArray<FRuntimeMeshLODProperties>& InLODs)
{
...
void UPtgRuntimeMesh::SetLODScreenSize(int32 LODIndex, float ScreenSize)
{
	RMC_LOG_VERBOSE("MarkLODDirty called: LOD:%d ScreenSize:%f", LODIndex, ScreenSize);
	// TODO: Implement
}

void UPtgRuntimeMesh::MarkLODDirty(int32 LODIndex)
{
...
void UPtgRuntimeMesh::MarkAllLODsDirty()
{
...
void UPtgRuntimeMesh::CreateSection(int32 LODIndex, int32 SectionId, const FRuntimeMeshSectionProperties& SectionProperties)
{
...
void UPtgRuntimeMesh::SetSectionVisibility(int32 LODIndex, int32 SectionId, bool bIsVisible)
{
...
void UPtgRuntimeMesh::SetSectionCastsShadow(int32 LODIndex, int32 SectionId, bool bCastsShadow)
{
...
void UPtgRuntimeMesh::MarkSectionDirty(int32 LODIndex, int32 SectionId)
{
...
void UPtgRuntimeMesh::ClearSection(int32 LODIndex, int32 SectionId)
{
...
void UPtgRuntimeMesh::RemoveSection(int32 LODIndex, int32 SectionId)
{
...
void UPtgRuntimeMesh::MarkCollisionDirty()
{
...
void UPtgRuntimeMesh::SetupMaterialSlot(int32 MaterialSlot, FName SlotName, UMaterialInterface* InMaterial)
{
...
int32 UPtgRuntimeMesh::GetMaterialIndex(FName MaterialSlotName)
{
	FScopeLock Lock(&SyncRoot);
...
bool UPtgRuntimeMesh::IsMaterialSlotNameValid(FName MaterialSlotName) const
{
	FScopeLock Lock(&SyncRoot);
	return SlotNameLookup.Contains(MaterialSlotName);
}

FRuntimeMeshMaterialSlot UPtgRuntimeMesh::GetMaterialSlot(int32 SlotIndex)
{
	FScopeLock Lock(&SyncRoot);
	return MaterialSlots[SlotIndex];
}

int32 UPtgRuntimeMesh::GetNumMaterials()
{
	FScopeLock Lock(&SyncRoot);
	return MaterialSlots.Num();
}

TArray<FName> UPtgRuntimeMesh::GetMaterialSlotNames()
{
	FScopeLock Lock(&SyncRoot);
...
TArray<FRuntimeMeshMaterialSlot> UPtgRuntimeMesh::GetMaterialSlots()
{
	FScopeLock Lock(&SyncRoot);
	return MaterialSlots;
}

UMaterialInterface* UPtgRuntimeMesh::GetMaterial(int32 SlotIndex)
{
	FScopeLock Lock(&SyncRoot);
...
void UPtgRuntimeMesh::BeginDestroy()
{
...
bool UPtgRuntimeMesh::IsReadyForFinishDestroy()
{
	return Super::IsReadyForFinishDestroy() && GCAnchor.IsFree();
}

void UPtgRuntimeMesh::PostLoad()
{
	Super::PostLoad();
...
void UPtgRuntimeMesh::PostEditImport()
{
	Super::PostEditImport();
}

void UPtgRuntimeMesh::PostDuplicate(EDuplicateMode::Type DuplicateMode)
{
...
bool UPtgRuntimeMesh::GetPhysicsTriMeshData(struct FTriMeshCollisionData* CollisionData, bool InUseAllTriData)
{
...
bool UPtgRuntimeMesh::ContainsPhysicsTriMeshData(bool InUseAllTriData) const
{
...
bool UPtgRuntimeMesh::WantsNegXTriMesh()
{
	return false;
}

void UPtgRuntimeMesh::GetMeshId(FString& OutMeshId)
{
...
void UPtgRuntimeMesh::QueueForDelayedInitialize()
{
...
void UPtgRuntimeMesh::QueueForUpdate()
{
...
void UPtgRuntimeMesh::QueueForMeshUpdate()
{
...
void UPtgRuntimeMesh::QueueForCollisionUpdate()
{
	FRuntimeMeshMisc::DoOnGameThread([MeshPtr = GetMeshReference()]()
	{
		FRuntimeMeshSharedRef Mesh = MeshPtr.Pin();
...
void UPtgRuntimeMesh::UpdateAllComponentBounds()
{
	FRuntimeMeshMisc::DoOnGameThread([MeshPtr = GetMeshReference()]()
	{
		FRuntimeMeshSharedRef Mesh = MeshPtr.Pin();
...
void UPtgRuntimeMesh::RecreateAllComponentSceneProxies()
{
...
void UPtgRuntimeMesh::HandleUpdate()
{
...
void UPtgRuntimeMesh::HandleFullLODUpdate(const FRuntimeMeshProxyPtr& RenderProxyRef, int32 LODId, bool& bRequiresProxyRecreate)
{
...
void UPtgRuntimeMesh::HandleSingleSectionUpdate(const FRuntimeMeshProxyPtr& RenderProxyRef, int32 LODId, int32 SectionId, bool& bRequiresProxyRecreate)
{
...
URuntimeMeshComponentEngineSubsystem* UPtgRuntimeMesh::GetEngineSubsystem()
{
...
UBodySetup* UPtgRuntimeMesh::CreateNewBodySetup()
{
...
void UPtgRuntimeMesh::UpdateCollision(bool bForceCookNow)
{
	...
	if (MeshProviderPtr)
	{
		...
		if (bShouldCookAsync)
		{
			...
			NewBodySetup->CreatePhysicsMeshesAsync(
				FOnAsyncPhysicsCookFinished::CreateUObject(this, &UPtgRuntimeMesh::FinishPhysicsAsyncCook, NewBodySetup));
...
void UPtgRuntimeMesh::FinishPhysicsAsyncCook(bool bSuccess, UBodySetup* FinishedBodySetup)
{
...
void UPtgRuntimeMesh::FinalizeNewCookedData()
{
...
void UPtgRuntimeMesh::RegisterLinkedComponent(URuntimeMeshComponent* NewComponent)
{
...
void UPtgRuntimeMesh::UnRegisterLinkedComponent(URuntimeMeshComponent* ComponentToRemove)
{
...
void UPtgRuntimeMesh::EnsureRenderProxyReady()
{
	FReadScopeLock Lock(MeshProviderLock);
...
FRuntimeMeshProxyPtr UPtgRuntimeMesh::GetRenderProxy(ERHIFeatureLevel::Type InFeatureLevel)
{
	if (RenderProxy.IsValid())
	{
		return RenderProxy;
...
bool UPtgRuntimeMesh::GetSceneFeatureLevel(ERHIFeatureLevel::Type& OutFeatureLevel)
{
